        ...
        <div class="modal-content modal-md">
            ...
            <form action="{{ route('addData') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 row">
                        <label for="deskripsiProduct" class="col-sm-5 col-form-label">Deskripsi Product</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="deskripsiProduct" name="deskripsi" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            ...
                            <input type="file" class="form-control" accept=".png, .jpg, .jpeg" id="inputFoto"
                                name="foto" onchange="previewImg()" required>
                        </div>
                    </div>
                </div>
